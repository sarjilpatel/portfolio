...
import { Profile, Project, SkillCategory, Experience, Certification } from "@/lib/types"
...
export default function AdminPage() {
  ...
  const [profile, setProfile] = useState<Profile>(profileDataRaw as Profile)
  const [projects, setProjects] = useState<Project[]>(projectsDataRaw as Project[])
  const [skills, setSkills] = useState<SkillCategory[]>(skillsDataRaw as SkillCategory[])
  const [experience, setExperience] = useState<Experience[]>(experienceDataRaw as Experience[])
  const [certifications, setCertifications] = useState<Certification[]>(certificationsDataRaw as Certification[])
